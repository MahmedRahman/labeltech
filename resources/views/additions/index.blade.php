<x-app-layout>
    ...
    <div style="margin-bottom: 1.5rem; display: flex; justify-content: space-between; align-items: center;">
        <div>
            <h2 style="font-size: 1.75rem; font-weight: 700; color: #111827; margin: 0 0 0.25rem 0;">قائمة الاضافات</h2>
            <p style="font-size: 1rem; color: #6b7280; margin: 0;">إدارة جميع أنواع الاضافات المتاحة</p>
        </div>
        ...
        <div class="table-content">
            ...
            @else
                <div style="text-align: center; padding: 3rem 0;">
                    ...
                    <p style="font-size: 1rem; color: #6b7280; margin-bottom: 1.5rem;">ابدأ بإضافة اضافة جديدة</p>
