<x-app-layout>
    ...
    <div class="table-container">
        <div class="table-header">
            <h3 style="font-size: 1.125rem; font-weight: 600; color: #111827; margin: 0;">آخر العملاء</h3>
            <a href="{{ route('clients.index') }}" style="color: #2563eb; text-decoration: none; font-size: 0.875rem;">عرض الكل</a>
        </div>
    ...
    <div class="table-container" style="margin-top: 1.5rem;">
        <div class="table-header">
            <h3 style="font-size: 1.125rem; font-weight: 600; color: #111827; margin: 0;">آخر الموظفين</h3>
            <a href="{{ route('employees.index') }}" style="color: #2563eb; text-decoration: none; font-size: 0.875rem;">عرض الكل</a>
        </div>
        <div class="table-content">
                    ...
                    <tbody>
                        @foreach($recentEmployees as $employee)
                            <tr>
                                ...
                                <td style="color: #6b7280;">{{ $employee->created_at->format('Y-m-d') }}</td>
                                <td>
                                    <div style="display: flex; gap: 0.75rem;">
    ...
    <div class="table-container" style="margin-top: 1.5rem;">
        <div class="table-header">
            <h3 style="font-size: 1.125rem; font-weight: 600; color: #111827; margin: 0;">آخر الموردين</h3>
            <a href="{{ route('suppliers.index') }}" style="color: #2563eb; text-decoration: none; font-size: 0.875rem;">عرض الكل</a>
        </div>
        <div class="table-content">
            ...
            @else
                <div style="text-align: center; padding: 3rem 0;">
                    ...
                    <p style="font-size: 0.875rem; color: #6b7280; margin-bottom: 1.5rem;">ابدأ بإضافة مورد جديد</p>
    ...
    <div class="table-container" style="margin-top: 1.5rem;">
        <div class="table-header">
            <h3 style="font-size: 1.125rem; font-weight: 600; color: #111827; margin: 0;">آخر أوامر الشغل</h3>
            <a href="{{ route('work-orders.index') }}" style="color: #2563eb; text-decoration: none; font-size: 0.875rem;">عرض الكل</a>
        </div>
        <div class="table-content">
