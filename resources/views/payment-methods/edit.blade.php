    ...
    <div class="form-container">
        <div class="form-card">
            <div class="form-header">
                <h2>تعديل طريقة السداد</h2>
                <p>تحديث معلومات طريقة السداد: {{ $paymentMethod->name }}</p>
            </div>
            ...
            <form action="{{ route('payment-methods.update', $paymentMethod) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" 
                              ...
                              rows="4"
                              class="form-textarea"
                              placeholder="وصف مختصر عن طريقة السداد">{{ old('description', $paymentMethod->description) }}</textarea>
                    @error('description')
                        <p class="error-message">{{ $message }}</p>
                    @enderror
                </div>
