<x-app-layout>
    ...
    <div style="margin-bottom: 1.5rem; display: flex; justify-content: space-between; align-items: center;">
        <div>
            <h2 style="font-size: 1.75rem; font-weight: 700; color: #111827; margin: 0 0 0.25rem 0;">بيانات الخامة</h2>
            <p style="font-size: 1rem; color: #6b7280; margin: 0;">{{ $material->name }}</p>
        </div>
