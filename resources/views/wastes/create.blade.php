                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <select name="number_of_colors" 
                            ...
                            <option value="0" {{ old('number_of_colors') == 0 ? 'selected' : '' }}>0</option>
                            <option value="1" {{ old('number_of_colors') == 1 ? 'selected' : '' }}>1</option>
                            <option value="2" {{ old('number_of_colors') == 2 ? 'selected' : '' }}>2</option>
                            <option value="3" {{ old('number_of_colors') == 3 ? 'selected' : '' }}>3</option>
                            <option value="4" {{ old('number_of_colors') == 4 ? 'selected' : '' }}>4</option>
                            <option value="5" {{ old('number_of_colors') == 5 ? 'selected' : '' }}>5</option>
                            <option value="6" {{ old('number_of_colors') == 6 ? 'selected' : '' }}>6</option>
                        </select>
