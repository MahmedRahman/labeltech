                        ...
                        <div style="display: flex; gap: 1rem; margin-top: 0.5rem; flex-wrap: wrap;">
                            ...
                            <label class="number-of-colors-card" style="display: flex; align-items: center; justify-content: center; gap: 0.5rem; cursor: pointer; padding: 1rem 1.5rem; border: 2px solid #d1d5db; border-radius: 0.5rem; transition: all 0.2s; min-width: 60px; text-align: center;">
                                <input type="radio" 
                                       ...
                                       {{ old('number_of_colors', $workOrder->number_of_colors ?? 4) == $i ? 'checked' : '' }}
                                       required
                    ...
                    <div style="display: flex; gap: 0.75rem; margin-top: 0.5rem; flex-wrap: wrap;">
                        ...
                        <label class="rows-count-card" style="display: flex; align-items: center; justify-content: center; gap: 0.5rem; cursor: pointer; padding: 0.875rem 1.25rem; border: 2px solid #d1d5db; border-radius: 0.5rem; transition: all 0.2s; min-width: 50px; text-align: center;">
                            <input type="radio" 
                                   ...
                                   value="{{ $i }}" 
                                   id="rows_count_{{ $i }}"
                                   {{ old('rows_count', $workOrder->rows_count ?? 1) == $i ? 'checked' : '' }}
                                   style="width: 18px; height: 18px; cursor: pointer; accent-color: #2563eb;">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="number" 
                               name="gap_count" 
                               id="gap_count" 
                               value="{{ old('gap_count', $workOrder->gap_count ?? 0.4) }}" 
                               min="0"
                               step="0.01"
                               class="form-input"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               name="waste_per_roll" 
                               id="waste_per_roll" 
                               value="{{ old('waste_per_roll', $workOrder->waste_per_roll ?? 20) }}" 
                               min="0"
                               step="1"
                               class="form-input"
                ...
                <div style="margin-bottom: 2rem; padding: 1.5rem; background-color: #f9fafb; border-radius: 0.5rem; border: 1px solid #e5e7eb;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               name="film_price" 
                               id="film_price" 
                               value="{{ old('film_price', $workOrder->film_price ?? 850) }}" 
                               step="0.01"
                               min="0"
                               class="form-input"
                               placeholder="0.00">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               id="sales_percentage" 
                               value="{{ old('sales_percentage', $workOrder->sales_percentage ?? 10) }}" 
                               step="0.01"
                               min="0"
                               max="100"
                               class="form-input"
                    ...
                    <div id="fingerprint_price_group" class="form-group" style="display: {{ old('fingerprint', $workOrder->fingerprint ?? null) == 'yes' ? 'block' : 'none' }};">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('fingerprint_price', $workOrder->fingerprint_price ?? 16) }}" 
                               step="0.01"
                               min="0"
                               class="form-input"
                               placeholder="0.00"
                    ...
                    <div id="knife_price_group" class="form-group" style="display: {{ old('knife_exists', $workOrder->knife_exists ?? null) == 'yes' ? 'block' : 'none' }};">
                        ...
                        <input type="number" 
                               name="knife_price" 
                               id="knife_price" 
                               value="{{ old('knife_price', $workOrder->knife_price ?? 600) }}" 
                               step="0.01"
                               min="0"
                               class="form-input"
                               placeholder="0.00"
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('manufacturing_price_per_meter', $workOrder->manufacturing_price_per_meter ?? 10) }}" 
                                   step="0.01"
                                   min="0"
                                   class="form-input"
                                   placeholder="0.00">
