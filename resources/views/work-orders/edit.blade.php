            ...
            <form action="{{ route('work-orders.update', $workOrder) }}" method="POST">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               name="material" 
                               id="material" 
                               value="{{ old('material', $workOrder->material) }}" 
                               required
                               class="form-input">
                        @error('material')
                            <p class="error-message">{{ $message }}</p>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               id="number_of_colors" 
                               value="{{ old('number_of_colors', $workOrder->number_of_colors) }}" 
                               required
                               min="1"
                               class="form-input">
                ...
                <div class="form-group">
                    ...
                    <textarea name="final_product_shape" 
                              ...
                              rows="3"
                              class="form-textarea">{{ old('final_product_shape', $workOrder->final_product_shape) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="additions" 
                              id="additions" 
                              rows="3"
                              class="form-textarea">{{ old('additions', $workOrder->additions) }}</textarea>
                    @error('additions')
                        <p class="error-message">{{ $message }}</p>
                    @enderror
                </div>
