    ...
    <div class="form-container">
        <div class="form-card">
            <div style="margin-bottom: 2rem;">
                <h2 style="font-size: 1.5rem; font-weight: 700; color: #111827; margin: 0 0 0.5rem 0;">إضافة فريق مبيعات جديد</h2>
                <p style="font-size: 1rem; color: #6b7280; margin: 0;">املأ البيانات التالية لإضافة فريق مبيعات جديد</p>
            </div>
