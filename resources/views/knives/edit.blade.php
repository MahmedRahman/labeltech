    ...
    <div class="form-container">
        <div class="form-card">
            <div class="form-header">
                <h2>تعديل السكينة</h2>
                <p>تعديل بيانات السكينة: {{ $knife->knife_code }}</p>
            </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="knife_code" 
                                   id="knife_code" 
                                   value="{{ old('knife_code', $knife->knife_code) }}" 
                                   required
                                   class="form-input"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="knife_name" 
                                   id="knife_name" 
                                   value="{{ old('knife_name', $knife->knife_name) }}" 
                                   required
                                   class="form-input"
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="knife_type" 
                                   id="knife_type" 
                                   value="{{ old('knife_type', $knife->knife_type) }}" 
                                   class="form-input"
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="grain_direction" 
                                   value="{{ old('grain_direction', $knife->grain_direction) }}" 
                                   class="form-input"
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   id="knife_thickness" 
                                   value="{{ old('knife_thickness', $knife->knife_thickness) }}" 
                                   step="0.01"
                                   min="0"
                                   class="form-input"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   name="crease_lines" 
                                   id="crease_lines" 
                                   value="{{ old('crease_lines', $knife->crease_lines) }}" 
                                   min="0"
                                   class="form-input"
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   name="punch_holes" 
                                   id="punch_holes" 
                                   value="{{ old('punch_holes', $knife->punch_holes) }}" 
                                   min="0"
                                   class="form-input"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="drill_size" 
                                   id="drill_size" 
                                   value="{{ old('drill_size', $knife->drill_size) }}" 
                                   class="form-input"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               name="material_type" 
                               id="material_type" 
                                   value="{{ old('material_type', $knife->material_type) }}"
                               class="form-input"
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="date" 
                                   name="purchase_date" 
                                   id="purchase_date" 
                                   value="{{ old('purchase_date', $knife->purchase_date ? $knife->purchase_date->format('Y-m-d') : '') }}" 
                                   class="form-input">
                            @error('purchase_date')
                                <p class="error-message">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <select name="knife_status" 
                                    ...
                                    required
                                    class="form-select">
                                <option value="active" {{ old('knife_status', $knife->knife_status) == 'active' ? 'selected' : '' }}>نشط</option>
                                <option value="inactive" {{ old('knife_status', $knife->knife_status) == 'inactive' ? 'selected' : '' }}>غير نشط</option>
                                <option value="maintenance" {{ old('knife_status', $knife->knife_status) == 'maintenance' ? 'selected' : '' }}>صيانة</option>
                                <option value="retired" {{ old('knife_status', $knife->knife_status) == 'retired' ? 'selected' : '' }}>متقاعد</option>
                            </select>
                            @error('knife_status')
                                <p class="error-message">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   name="usage_count" 
                                   id="usage_count" 
                                   value="{{ old('usage_count', $knife->usage_count) }}" 
                                   min="0"
                                   class="form-input"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="storage_location" 
                                   value="{{ old('storage_location', $knife->storage_location) }}" 
                                   class="form-input"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="notes" 
                                  ...
                                  rows="3"
                                  class="form-textarea"
                                  placeholder="أي ملاحظات إضافية">{{ old('notes', $knife->notes) }}</textarea>
                        @error('notes')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
